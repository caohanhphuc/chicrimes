...
def delete_non_index(dict_list, header_list, index_iucr, violent_index_iucr, all_iucr):
	...
	for d in dict_list:
		...
		if iucr in violent_index_iucr or iucr_str in violent_index_iucr:
			...
			if (iucr in {"0840", "0841", "0842", "0843", "0499"}):
				d["Violent"] = 1
				violent_1 += 1
			elif (iucr in {"5008", "5005", "5093", "5073", "5094", "5114"}):
				d["Violent"] = 2
				violent_2 += 1
			else:
				print("Not in list: ")
	...
	print("violent_0: %s", violent_0)
	print("violent_1: %s", violent_1)
	print("violent_2: %s", violent_2)
...
remove_list = {"ID", "\xef\xbb\xbfID", "Updated On", "Case Number", "Case number", "\xef\xbb\xbfCase Number" , "Primary Type", "FBI Code", "Description", "Arrest", "Domestic", "Year", "Location", "X Coordinate", "Y Coordinate", "Latitude", "Longitude"}
...
cleaning("../data/2012.csv", remove_list, "../data/2012_violent_cleaned.csv", index_iucr, violent_index_iucr, all_iucr)
